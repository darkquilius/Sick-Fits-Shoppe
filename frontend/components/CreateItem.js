...
class CreateItem extends Component {
    ...
    uploadFile = async e  => {
        ...
        const res = await fetch('https://api.cloudinary.com/v1_1/darkquilius/image/upload', {
            method: 'POST',
            body: data
        })
                    ...
                    return(
                        <Form onSubmit={async e => {
                            ...
                            <label htmlFor="file">
                                    ...
                                    {this.state.image && <img src={this.state.image} alt="upload preview"></img>}
                                </label>
                                ...
                                <label htmlFor="description">
                                    Description
                                    <input id="description" name="description" placeholder="Enter Description" value={this.state.description} onChange={this.handleChange} required />
                                </label>
